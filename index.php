<?php
    //Required files
        ...
        require_once "mysql/page_query/important/pq_index.php";
?>
<!DOCTYPE html>
<html>
    <head>
        <?php require_once "html_head_tags/important/ph_index.php"; ?>
    </head>
    <body>
        <div class="container">
            ...
            <div class="main_content_container">
                ...
                <div class="central_container">
                    <?php
                        ...
                        {
                            $comments_topic = mysql_query("select * from prof_main_topic_comment where for_topic = '$central->id' order by id desc");
                            echo "<div class='central'>
                                    <div class='title'><a href='view_topic.php?id=$central->id'>$central->title</a></div>
                                    <div class='content'>$central->description</div>
						...
						if(mysql_num_rows($central_items) >= 6)
						{
							echo "<div class='view_all'><a href='topics_archive.php'>Прегледай всички статии - [".mysql_num_rows($central_items)."]</a></div>";
						}
                    ?>
                </div>
            </div>
